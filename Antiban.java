...
import Boellis_PlankMake.AntibanAttributes.Misc;
import Boellis_PlankMake.AntibanAttributes.Skills;
    ...
    public void antiban(int l, int h) {
        ...
        switch (switcher) {
            ...
            case 13:
                if(checkHitpoints) {
                    checkHitpoints();
                    //skills.checkHitpoints();
                }
                break;
            case 14:
                if(checkFiremaking) {
                    checkFiremaking();
                    //skills.checkFiremaking();
                }
                break;
            case 15:
                if(checkRange) {
            ...
            case 19:
                if(checkStrength) {
                    checkStrength();
                    //skills.checkStrength();
                }
                break;
            case 20:
                if(checkSmithing) {
                    checkSmithing();
                    //skills.checkSmithing();
                }
                break;
            case 21:
                if(checkMagic){
            ...
            case 28:
                if(checkThieving) {
                    checkThieving();
                    //skills.checkThieving();
                }
                break;
            case 29:
                if(checkCrafting) {
                    checkCrafting();
                    //skills.checkCrafting();
                }
                break;
            case 30:
                if(checkFletching) {
                    checkFletching();
                    //skills.checkFletching();
                }
                break;
            case 31:
                if(checkHunter) {
            ...
            case 34:
                if(checkWoodcutting) {
                    checkWoodCutting();
                    //skills.checkWoodCutting();
                }
                break;
            case 35:
                if(checkIgnore) {
                    checkIgnoreList();
                    //misc.checkIgnoreList();
                }
                break;
            case 36:
                if(checkTotal){
